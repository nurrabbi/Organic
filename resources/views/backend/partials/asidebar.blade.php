...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Admin Control</span>
        </li>
        <!-- users -->
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="" class="menu-link">
                        <div data-i18n="Basic">Customize User</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <div data-i18n="Layouts">Product Categories</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="{{ route('product_category.create') }}" class="menu-link">
        ...
        @include('backend.deletables.asidebar')
    </ul>
</aside>
<!-- / Menu -->
