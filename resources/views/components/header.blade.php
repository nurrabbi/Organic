    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="{{ asset('backend') }}/img/logo-mini.png"
            ...
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="{{ asset('backend') }}/img/logo-mini.png"
                    alt="{{ config('app.name', 'Laravel') }}" style="width: auto; height: 33px;">
                <img class="side-nav-hide-on-closed" src="{{ asset('backend') }}/img/logo.png"
                    alt="{{ config('app.name', 'Laravel') }}" alt="{{ config('app.name', 'Laravel') }}"
