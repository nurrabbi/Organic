        ...
        <div class="container-lg">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <input type="tel" class="form-control profile-input d-none"
                                            id="profile-contact" name="phone" value=" {{ $user->phone }}"
                                            required>
                                    </div>
                                    <div class="col-md-6">
            ...
            <section class="mb-5" id="order-details">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-4">
                        <div class="soft-card account-stat-card h-100"><small class="text-secondary">Available
                                Coins</small>
                            <div class="account-stat-value">{{ $user->userDetail->coins }}</div>
                            <p class="mb-0 text-secondary">Organic Coins</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="soft-card account-stat-card h-100"><small class="text-secondary">Total
                                Orders</small>
                            <div class="account-stat-value">12</div>
                            <p class="mb-0 text-secondary">Orders placed</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="soft-card account-stat-card h-100"><small class="text-secondary">Lifetime
                                Spend</small>
                            <div class="account-stat-value">$ {{ $user->userDetail->total_purchase }}</div>
                            <p class="mb-0 text-secondary">Across all orders</p>
                        </div>
                    </div>
                </div>
                <div class="soft-card">
