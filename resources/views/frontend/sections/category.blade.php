                    ...
                    <div class="swiper-wrapper">
                        @foreach ($categories as $category)
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="{{ $category->image }}" class="rounded-circle" alt="{{ $category->category_name }}" style="width: 160px; height: 160px; object-fit: cover;">
                                <h4 class="fs-6 mt-3 fw-normal category-title">{{ $category->category_name }}</h4>
                            </a>
                        @endforeach
                        {{-- <a href="category.html" class="nav-link swiper-slide text-center">
