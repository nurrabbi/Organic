            ...
            <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-4">
                <div class="search-bar row bg-light p-2 rounded-4">
                    ...
                    <div class="col-11 col-md-7">
                        <form id="search-form" enctype="multipart/form-data" class="text-center"
                            action="{{ route('products.index') }}" method="post">
                            @csrf
                            <input type="text" class="form-control border-0 bg-transparent" id="search"
                                placeholder="Search for more than 20,000 products" value="{{ request('search') }}"
                                autocomplete="off">
                    </div>
