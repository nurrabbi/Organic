...
<head>
    ...
    <link href="{{ asset('frontend') }}/css/vendor.css" rel="stylesheet" type="text/css" />
...
<body>
    <svg style="display: none;" xmlns="http://www.w3.org/2000/svg">
        <defs>
            ...
            <symbol id="amazon" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="package" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <path d="m24 13.264l7.288 4.21L24 21.681l-7.288-4.209Z" fill="none" stroke="currentColor"
                    stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M16.712 17.473v8.418L24 30.101l7.288-4.21v-8.418M24 30.1v-8.418" fill="none"
            ...
            <symbol id="secure" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.134 36V20.11h19.732M19.279 36h14.587V25.45" fill="none" stroke="currentColor"
                    stroke-linecap="round" stroke-linejoin="round"></path>
                <path
                    d="m19.246 26.606l4.135 4.135l5.373-5.372m-8.934-9.282a4.087 4.087 0 1 1 8.174 0m0 0v4.023m-8.172-4.108v4.108"
                    fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                <path d="M30.288 44.566a21.516 21.516 0 1 1 9.69-6.18" fill="none" stroke="currentColor"
                    stroke-linecap="round" stroke-linejoin="round"></path>
            </symbol>
            <symbol id="quality" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <path d="m30.59 13.45l4.77 2.94L24 34.68l-10.33-7l3.11-4.6l5.52 3.71l8.26-13.38Z" fill="none"
                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                <path
            ...
            <symbol id="savings" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <circle cx="24" cy="24" fill="none" r="21.5" stroke="currentColor"
            ...
            <symbol id="offers" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="delivery" viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="organic" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="fresh" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none">
                    <path
            ...
            <symbol id="star-full" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="user" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5">
                    ...
                    <path d="M17.97 20c-.16-2.892-1.045-5-5.97-5s-5.81 2.108-5.97 5" stroke-linecap="round"></path>
                </g>
            </symbol>
            <symbol id="wishlist" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5">
                    <path
                    ...
                    <path d="M15 6H9" stroke-linecap="round"></path>
                </g>
            </symbol>
            <symbol id="shopping-bag" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5">
                    <path
                    ...
                    <path d="M8 13v4m8-4v4m-4-4v4" stroke-linecap="round" stroke-linejoin="round"></path>
                </g>
            </symbol>
            <symbol id="fruits" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
            ...
            <symbol id="dairy" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <g fill="none">
            ...
            <symbol id="meat" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <g fill="currentColor">
            ...
            <symbol id="seafood" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="bakery" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="canned" viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <g fill="none">
                    <g clip-path="url(#fluentEmojiHighContrastCannedFood0)" fill="currentColor">
                        <path
            ...
            <symbol id="frozen" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5">
                    <path
                    ...
                    <path d="M17 21v1h-1v-1m-8 0v1H7v-1" stroke-linejoin="round"></path>
                    <path d="M20 11.5H4"></path>
                    <path d="M17 7v2m0 5v2" stroke-linecap="round"></path>
                </g>
            </symbol>
            <symbol id="pasta" viewbox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="breakfast" viewbox="0 0 2048 2048" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="snacks" viewbox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="4">
                    <path d="M6 14h36V8h-4l-2-4H12l-2 4H6z"></path>
                    <path d="m36 44l2-30H10l2 30z" stroke-linecap="round"></path>
                </g>
            </symbol>
            <symbol id="beverages" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="spices" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="baby" viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    fill="currentColor"></path>
                <path d="M168 232h40v40h-40zm136 0h40v40h-40zm-48 152a80 80 0 0 0 80-80H176a80 80 0 0 0 80 80"
                    fill="currentColor"></path>
            </symbol>
            <symbol id="health" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="household" viewbox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
            ...
            <symbol id="personal" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="pet" viewbox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <symbol id="admin-panel" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <symbol id="manage-accounts" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="12" cy="7" r="3"></circle>
                    <path d="M17.97 17c-.16-2.5-1.045-4-5.97-4s-5.81 1.5-5.97 4"></path>
                    <circle cx="12" cy="17" r="2"></circle>
                    <path d="M12 14v1m0 4v1m2.5-2.5h-1m-3 0h-1"></path>
                </g>
            </symbol>
            <symbol id="lock-control" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="settings-gear" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="activity-log" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M3 12h3l3-9 4 18 3-12h4"></path>
                </g>
            </symbol>
            <symbol id="database" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="dashboard-grid" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="chart-bar" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="chart-line" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="chart-pie" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="analytics-globe" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="12" cy="12" r="10"></circle>
                    <path
            ...
            <symbol id="analytics-funnel" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M22 3H2l8 9.46V19l4 2v-8.54L22 3z"></path>
                </g>
            </symbol>
            <symbol id="revenue-growth" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    ...
                    <path d="M16 6H10.5a3.5 3.5 0 1 0 0 7h3a3.5 3.5 0 1 1 0 7H7"></path>
                </g>
            </symbol>
            <symbol id="cart-analytics" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="order-value" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="conversion-target" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="12" cy="12" r="10"></circle>
            ...
            <symbol id="inventory-stock" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path
            ...
            <symbol id="customer-value" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
                    <circle cx="9" cy="7" r="4"></circle>
                    <polygon points="19 11 20.5 12 20 10.2 21.5 9 19.7 8.9 19 7 18.3 8.9 16.5 9 18 10.2 17.5 12">
                    </polygon>
                </g>
            </symbol>
            <symbol id="shipping-truck" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="logistics-package" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="route-tracking" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="air-freight" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path
                        d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4a2 2 0 0 0 1-1.73z">
                    ...
                    <path d="M12 12l8.7-5M12 12L3.3 7"></path>
                </g>
            </symbol>
            <symbol id="warehouse" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="express-delivery" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path>
                </g>
            </symbol>
            <symbol id="home" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="search" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="menu" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="grid" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="more-vertical" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="more-horizontal" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="12" cy="12" r="1" />
            ...
            <symbol id="close" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="check" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                </g>
            </symbol>
            <symbol id="plus" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="minus" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <line x1="5" y1="12" x2="19" y2="12" />
                </g>
            </symbol>
            <symbol id="info" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="help-circle" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="12" cy="12" r="10" />
            ...
            <symbol id="alert-circle" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="12" cy="12" r="10" />
            ...
            <symbol id="filter" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3" />
                </g>
            </symbol>
            <symbol id="sort" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="refresh" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.57-8.38l5.67-5.67" />
                </g>
            </symbol>
            <symbol id="external-link" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="share" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="bookmark" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
            </symbol>
            <symbol id="target" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="12" cy="12" r="10" />
            ...
            <symbol id="edit" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="trash" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="save" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="copy" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="file" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="file-text" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="folder" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
                </g>
            </symbol>
            <symbol id="folder-plus" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
            ...
            <symbol id="download" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="upload" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
            ...
            <symbol id="link" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="paperclip" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path
            ...
            <symbol id="eye" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="eye-off" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path
            ...
            <symbol id="cloud" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" />
                </g>
            </symbol>
            <symbol id="terminal" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="hard-drive" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="archive" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="server" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="image" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="arrow-up" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="arrow-down" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <line x1="12" y1="5" x2="12" y2="19" />
            ...
            <symbol id="arrow-left" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="arrow-right" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <line x1="5" y1="12" x2="19" y2="12" />
            ...
            <symbol id="chevron-up" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="18 15 12 9 6 15" />
                </g>
            </symbol>
            <symbol id="chevron-down" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="6 9 12 15 18 9" />
                </g>
            </symbol>
            <symbol id="chevron-left" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="15 18 9 12 15 6" />
                </g>
            </symbol>
            <symbol id="chevron-right" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="9 18 15 12 9 6" />
                </g>
            </symbol>
            <symbol id="arrow-up-right" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="arrow-down-left" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="chevrons-right" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="chevrons-left" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="maximize" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7" />
                </g>
            </symbol>
            <symbol id="minimize" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7" />
                </g>
            </symbol>
            <symbol id="move" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="log-in" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="log-out" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="corner-down-right" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="rotate-ccw" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M1 4v6h6" />
            ...
            <symbol id="shuffle" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="16 3 21 3 21 8" />
                    <line x1="4" y1="20" x2="21" y2="3" />
                    <polyline points="21 16 21 21 16 21" />
                    <line x1="15" y1="15" x2="21" y2="20" />
                    <line x1="4" y1="4" x2="9" y2="9" />
                </g>
            </symbol>
            <symbol id="mail" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="bell" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="bell-off" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M13.73 21a2 2 0 0 1-3.46 0" />
                    <path d="M18.4 13A14 14 0 0 1 18 8A6 6 0 0 0 7.8 5.8M4.6 4.6l14.8 14.8M3 17h14M8 12v5" />
                </g>
            </symbol>
            <symbol id="message-circle" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path
            ...
            <symbol id="message-square" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                </g>
            </symbol>
            <symbol id="phone" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path
            ...
            <symbol id="video" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="globe" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="12" cy="12" r="10" />
                    <line x1="2" y1="12" x2="22" y2="12" />
            ...
            <symbol id="map-pin" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="send" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="users" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="user-check" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="user-minus" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
                    <circle cx="9" cy="7" r="4" />
            ...
            <symbol id="at-sign" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="wifi" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="bluetooth" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
            ...
            <symbol id="share-2" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <circle cx="18" cy="5" r="3" />
                    <circle cx="6" cy="12" r="3" />
            ...
            <symbol id="activity" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
                </g>
            </symbol>
            <symbol id="shield" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                </g>
            </symbol>
            <symbol id="award" viewBox="0 0 24 24" xmlns="http://w3.org">
                <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round">
    ...
    <header>
        <div class="container-fluid">
            <div class="row py-3 border-bottom">
                <div class="col-sm-12 d-flex gap-3 align-items-center justify-content-center">
                    <ul class="d-flex justify-content-center list-unstyled m-0 flex-wrap">
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Facebook">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Twitter">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="YouTube">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Instagram">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Amazon">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Menu">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Link">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Arrow Right">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Category">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Calendar">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Heart">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Plus">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Minus">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Cart">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Check">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Trash">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Search">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Close">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Package">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Secure">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Quality">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Savings">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Offers">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Delivery">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Organic">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Fresh">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Star Full">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Star Half">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="User">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Wishlist">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Shopping Bag">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Fruits">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Dairy">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Meat">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Seafood">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Bakery">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Canned">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Frozen">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Pasta">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Breakfast">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Snacks">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Beverages">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Spices">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Baby">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Health">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Household">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Personal">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Pet">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Admin Panel">
                                <svg width="24" height="24">
                                    <use xlink:href="#admin-panel"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Manage Accounts">
                                <svg width="24" height="24">
                                    <use xlink:href="#manage-accounts"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Lock Control">
                                <svg width="24" height="24">
                                    <use xlink:href="#lock-control"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Settings">
                                <svg width="24" height="24">
                                    <use xlink:href="#settings-gear"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Activity Log">
                                <svg width="24" height="24">
                                    <use xlink:href="#activity-log"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Database">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Dashboard">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Bar Chart">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Line Chart">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Pie Chart">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Analytics Globe">
                                <svg width="24" height="24">
                                    <use xlink:href="#analytics-globe"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip"
                                title="Analytics Funnel">
                                <svg width="24" height="24">
                                    <use xlink:href="#analytics-funnel"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Revenue Growth">
                                <svg width="24" height="24">
                                    <use xlink:href="#revenue-growth"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Cart Analytics">
                                <svg width="24" height="24">
                                    <use xlink:href="#cart-analytics"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Order Value">
                                <svg width="24" height="24">
                                    <use xlink:href="#order-value"></use>
                                </svg>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip"
                                ...
                                <svg width="24" height="24">
                                    <use xlink:href="#conversion-target"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Inventory Stock">
                                <svg width="24" height="24">
                                    <use xlink:href="#inventory-stock"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Customer Value">
                                <svg width="24" height="24">
                                    <use xlink:href="#customer-value"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Shipping Truck">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip"
                                ...
                                <svg width="24" height="24">
                                    <use xlink:href="#logistics-package"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Route Tracking">
                                <svg width="24" height="24">
                                    <use xlink:href="#route-tracking"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Air Freight">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Warehouse">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Home">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Grid">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="More Vertical">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="More Horizontal">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Info">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Help Circle">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Alert Circle">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Filter">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Sort">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Refresh">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="External Link">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Share">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Bookmark">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Target">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Edit">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Save">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Copy">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="File">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="File Text">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Folder">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Folder Plus">
                                <svg width="24" height="24">
                                    <use xlink:href="#folder-plus"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Download">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Upload">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Paperclip">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Eye">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Eye Off">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Cloud">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Terminal">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Hard Drive">
                                <svg width="24" height="24">
                                    <use xlink:href="#hard-drive"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Archive">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Server">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Image">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Arrow Up">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Arrow Down">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Arrow Left">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Chevron Up">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Chevron Down">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Chevron Left">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Chevron Right">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Arrow Up Right">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Arrow Down Left">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Chevrons Right">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Chevrons Left">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Maximize">
                                <svg width="24" height="24">
                                    <use xlink:href="#maximize"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Minimize">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Move">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Log In">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Log Out">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Rotate CCW">
                                <svg width="24" height="24">
                                    <use xlink:href="#rotate-ccw"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Shuffle">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Mail">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Bell">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Bell Off">
                                <svg width="24" height="24">
                                    <use xlink:href="#bell-off"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Message Circle">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Message Square">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Phone">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Video">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Globe">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Map Pin">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Send">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Users">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="User Check">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="User Minus">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="At Sign">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="WiFi">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Bluetooth">
                                <svg width="24" height="24">
                                    <use xlink:href="#bluetooth"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Share 2">
                                <svg width="24" height="24">
                                    <use xlink:href="#share-2"></use>
                                </svg>
                            </a>
                        </li>

                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Activity">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Shield">
                                <svg width="24" height="24">
                        ...
                        <li>
                            <a class="p-2 mx-1" href="#" data-bs-toggle="tooltip" title="Award">
                                <svg width="24" height="24">
