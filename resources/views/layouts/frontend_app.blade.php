...
<body>
    ...
    <!-- Cart Section -->
    @include('frontend_component.cart')
    <!-- /Cart Section -->
    ...
    @include('frontend_component.navbar')
    <!-- /Header/Navbar Section -->

    <!-- Banner Section -->
    @include('frontend_component.banner')
    <!-- /Banner Section -->

    <!-- Category Section -->
    @include('frontend_component.category')
    <!-- /Category Section -->

    <!-- Best selling Section  -->
    @include('frontend_component.best_selling')
    <!-- /Best Selling Section -->

    <!-- Items on SALE -->
    @include('frontend_component.items_on_sale')
    <!-- /Items on SALE -->

    <!-- Featured Products Section -->
    @include('frontend_component.featured_products')
    <!-- /Featured Products Section -->

    <!-- Newsletter Section -->
    @include('frontend_component.news_letter')
    <!-- /Newsletter Section -->

    <!-- Most Popular Products Section -->
    @include('frontend_component.most_popular_products')
    <!-- /Most Popular Products Section -->

    <!-- Latest Products Section -->
    @include('frontend_component.latest_products')
    <!-- /Products Section -->

    <!-- Blog Section -->
    @include('frontend_component.blog')
    <!-- /Blog Section -->

    <!-- Online App Section -->
    @include('frontend_component.app_link')
    <!-- /Online App Section -->

    <!-- Related Product Section -->
    @include('frontend_component.related_products')
    <!-- /Related Product Section -->

    <!-- Features Section -->
    @include('frontend_component.features') 
    <!-- /Features Section -->
